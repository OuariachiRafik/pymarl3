...
class Logger:
    ...
    #HRO
    def setup_wandb(self, project_name, directory_name, env_name, config_dict=None):
        run_id = "{}_{}".format(
            env_name,
            datetime.datetime.now().strftime("%Y-%m-%d_%H_%s")
        )
        wandb.init(project='sematic_causal_marl', dir=directory_name, config=config_dict, id=run_id)
