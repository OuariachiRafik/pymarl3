...
# -------- Encode centralized state to semantic latents z ----------
        ...
        # ---- UPDATE CMI MASKER -----------------------------------------
        if self.use_cmi_mask and  causal_update % 100==0:
        ...
        if self.use_state_blocks and self.use_cmi_mask and causal_update % 100==0 and self.use_intrinsic_rewards: #♥and causal_update > 5000 and causal_update % 1000==0:
            with th.no_grad():
        ...
        if self.use_state_blocks:
            if self.use_cmi_mask and causal_update > 100: # and causal_update % 1000==0:
